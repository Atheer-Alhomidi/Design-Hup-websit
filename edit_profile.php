                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control" type="text" name="describe_user" required value="<?php echo $describe_user; ?>">
                                        ...
                                        <!-- هذي بحذفها هههههه -->
                <tr>
                    <td style="font-weight: bold;">Relastionship Status</td>
                    <td>
                        <select class="form-control" name="Relastionship">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="recovery.php?id=<?php $user_id; ?>" method="post" id="f"><strong>What is your School Best Friend Name?</strong>
                                    <textarea class="form-control"  id="" cols="83" rows="4" name="content" placeholder="Someone"></textarea><br>
...
<?php
	if(isset($_POST['update'])){
                ...
                $update = "update users set f_name='$f_name', l_name='$l_name', user_name='$u_name', describe_user='$describe_user', Relationship='$Relationship_status', user_pass='$u_pass', user_email='$u_email', user_country='$u_country', user_gender='$u_gender', 
