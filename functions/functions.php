...
$con = mysqli_connect("localhost","root","","design_network") or die("Connection was not established");
                    ...
                    <div class='col-md-6 col-md-offset-3'>
                        <div class='panel panel-info'>
                            <div class='panel-body'>
                                ...
                                <button class='btn btn-info pull-right' name='reply'>Commment</button>
                                </form>
                            </div>
                        </div>
                    </div>
				...
				<div class='col-sm-6'>
					<div class='row' id='find_people'>
						...
						<div class='col-sm-6'>
							...
							<stronge><h2>$f_name $l_name</h2></stronge>
							</a>
						</div>
						<div class='col-sm-3'></div>
					</div>
