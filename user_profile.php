            ...
            if(isset($_GET['u_id'])){
                ...
                echo"
                    <div class='row'>
                        ...
                        <center>
                            <div style='backgrond-color: #e6e6e6;' class='col-sm-3'>
                            ...
                            <ul class='list-group'>
                                ...
                                <li class='list-group-item' title='User Status'><strong style='color:gry;'>$describe_user</strong></li>
                                ...
                                <li class='list-group-item' title='User Registeration Date'><strong >$register_date</strong></li>
                        ...
                        echo"
                            <div id='own_posts'>
                                ...
                                <div class='row'>
                                    ...
                                    <a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delet</button></a>
                                </div><br/><br/>
                            </div>
                        ";
                        }
